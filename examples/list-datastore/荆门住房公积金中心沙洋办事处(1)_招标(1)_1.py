...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 公示公告
            {
                "url": "http://zfgjj.jingmen.gov.cn/col/col5015/index.html",
                "page_number": 1,
            },
            # 政府采购
            {
                "url": "http://zfgjj.jingmen.gov.cn/col/col11796/index.html",
                "page_number": 1,
            },
            # 预决策公开
            {
                "url": "http://zfgjj.jingmen.gov.cn/col/col26971/index.html",
                "page_number": 1,
            },
