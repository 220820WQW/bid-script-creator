...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 通知公告
            {
                "url": "https://zjyc.tobacco.gov.cn/col/col97/index.html?uid=3689&pageNum=1",
                "page_number": 1,
            },
            # 行政规范性文件
            {
                "url": "https://zjyc.tobacco.gov.cn/col/col380/index.html",
                "page_number": 1,
            },
            # 行政规范性文件
            {
    ...
    def get_content(self, params: dict):
        ...
        content = soup.select_one('div.main-txt')

        if params['pubTime'] is None:
            t = soup.find('span', string=lambda t: t and "发布日期" in t)
