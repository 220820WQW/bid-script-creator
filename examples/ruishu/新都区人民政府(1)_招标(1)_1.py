...
def get_cookies():
    for _ in range(8):
        ...
        url = "https://www.xindu.gov.cn/gkml/zxgh/detail-list/column-index-1.shtml"
        ...
        path = acquire_subjoin_path("新都区人民政府1.js")
...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 通知公告
            {"url": "https://www.xindu.gov.cn/es-search/search/9077f2fd835f41cd99633cfe4dd1eb3a", "page_number": 1, "t": 2},
            # 专项规划
            {"url": "https://www.xindu.gov.cn/gkml/zxgh/detail-list/column-index-1.shtml", "page_number": 1, "t": 1},
            # 其他规划信息
            {"url": "https://www.xindu.gov.cn/gkml/qtghxx/detail-list/column-index-1.shtml", "page_number": 1, "t": 1},
            # 建设用地批准文件
            {"url": "https://www.xindu.gov.cn/es-search/search/b8be66ab6b85479c80ce2e04958f5f6d", "page_number": 1, "t": 2},
            # 征收土地公告
            {"url": "https://www.xindu.gov.cn/es-search/search/18fea71d232447edb67a0e37177fe0a9", "page_number": 1, "t": 2},
            # 征地补偿安置方案公告
            {"url": "https://www.xindu.gov.cn/es-search/search/63f8b0771ebc42eeaca1eafcff7d7087", "page_number": 1, "t": 2},
            # 成都市新都区水务局项目批准结果信息
            {"url": "https://www.xindu.gov.cn/es-search/search/403377ddeaff4255a8f40b462536c58d", "page_number": 1, "t": 2},
        )
