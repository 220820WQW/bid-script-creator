...
def get_cookies():
    for _ in range(8):
        ...
        url = "https://www.xinjin.gov.cn/xjxrmzf/c180293/gqxxzyfb_zc.shtml"
        ...
        path = acquire_subjoin_path("新津区人民政府门户网站1.js")
...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 项目招采
            {
                "url": "https://www.xinjin.gov.cn/es-search/search/34f4919fddc6421b857c1a3c817136c9",
                "page_number": 1,
            },
            # 资产招租
            {
                "url": "https://www.xinjin.gov.cn/es-search/search/56939b9bf0f14ac4ab83f45c979452c9",
                "page_number": 1,
            },
        )
    ...
    def get_list(self, params: dict):
        ...
        site_url = "https://www.xinjin.gov.cn/xjxrmzf/"

        for row in rows:
            a_tag = row.select_one('a')
            url = urljoin(site_url, a_tag.get('href'))
