...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 通知公告
            {
                "url": "http://www.hkzgh.org.cn/gzdt/tzgg/index.shtml",
                "page_number": 1,
            },
        )
    ...
    def get_list(self, params: dict):
        ...
        rows = soup.select('div.all_lists > div.every_listfloor')
    ...
    def get_content(self, params: dict):
        ...
        soup = BeautifulSoup(resp.text, "html.parser")
        content = soup.select_one('div.wzhang_cotens')

        if params['pubTime'] is None:
            t = soup.select_one('.title_rigon')
