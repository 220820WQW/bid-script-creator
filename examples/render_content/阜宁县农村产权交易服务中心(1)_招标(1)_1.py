...
HEADERS = {
    ...
    "Origin": "http://fnx.jsnc.gov.cn",
    "Referer": "http://fnx.jsnc.gov.cn/newiframe/ie8/preAnnouncement.html?id=1&unid=4028858b59b5d7e00159ba9b9465272d&allPath=1|4028858d49088aa201490d63ee3c01c4|4028858b59b5d7e00159ba9b9465272d|",
}
COOKIES = {}
...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 预公告
            {
                ...
                "data": {
                    "from": "1",
                    "unitId": "4028858b59b5d7e00159ba9b9465272d",
                    "allPath": "1|4028858d49088aa201490d63ee3c01c4|4028858b59b5d7e00159ba9b9465272d|",
                    "proTypeId": "",
                    "proTypeParentId": "",
                    "xmStatus": "0",
                    "cjDateStart": "",
    ...
    def get_list(self, params: dict):
        ...
        for row in rows:
            ...
            url = f"http://fnx.jsnc.gov.cn/ggxx/index.html?detailsID={row.get('proId')}&state={row.get('xmStatus')}&type={detail_type}&unid=4028858b59b5d7e00159ba9b9465272d"
            if not is_same_origin_url(url, "http://fnx.jsnc.gov.cn"):
                continue

            ret_list.append({'url': url, 'title': row.get('proName'), 'pubTime': pubTime})
