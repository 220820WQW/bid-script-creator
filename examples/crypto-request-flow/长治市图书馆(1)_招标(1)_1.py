...
HEADERS = {
    ...
    "origin": "https://www.czlib.sx.cn",
    "pragma": "no-cache",
    "priority": "u=1, i",
    "referer": "https://www.czlib.sx.cn/",
...
COOKIES = {
    "current_page_id": "989094",
    "website_id": "515165",
    "website_fid": "7723",
    "website_fid_login": "0",
    "mh_sign": "cea45fe114e6b6ed89bd62f27a2507f40522f70526fd27d0746456990bd3b8da",
    "goc": "o"
}
...
def get_sign():
    url = "https://www.czlib.sx.cn/engine2/m/6050437?p=989094&wfwfid=7723&pageId=989094&websiteId=515165&mhType=1&publicId=8304b0407d526311ee2ba5181739c0dece01&mhEnc=f9811bc06b0d1616c01c2a339c3148d2"
...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 通知公告
            {
                "url": "https://www.czlib.sx.cn/engine2/general/5060883/multi-type/more-datas",
                "page_number": 1,
                'data': {
                    "engineInstanceId": "6050437",
                    "sign": "",
                    "pageNum": "1",
                    "pageSize": "20",
                    "typeId": "12040409",
