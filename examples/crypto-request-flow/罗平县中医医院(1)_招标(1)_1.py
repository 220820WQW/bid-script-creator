...
HEADERS = {
    ...
    "Referer": "http://www.lpxzyy.cn/html/xinwenzhongxin/yiyuanxinwen/",
}
COOKIES = {}
...
def get_headers(url, proxies):
    ...
    mid_candidates = ["1366,768", "1536,864", "1920,1080", "1440,900"]
...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 医院新闻
            {
                "url": "http://www.lpxzyy.cn/html/xinwenzhongxin/yiyuanxinwen/",
                "page_number": 1,
            },
        )
    ...
    def get_list(self, params: dict):
        ...
        resp = auto_request(url=params['url'], headers=headers, cookies=COOKIES, allow_redirects=False, proxies=proxies)
        if 400 <= resp.status_code <= 599:
            return ret_list

        soup = BeautifulSoup(resp.text, "html.parser")
        wrap = soup.select_one('ul#news')
    ...
    def get_content(self, params: dict):
        ...
        soup = BeautifulSoup(resp.text, "html.parser")
        content = soup.select_one('div#bodyc')
