...
HEADERS = {
    ...
    "Origin": "https://www.pzhxqtsg.cn",
    "Pragma": "no-cache",
    "Referer": "https://www.pzhxqtsg.cn/",
...
COOKIES = {
    ...
    "website_fid": "29995",
    "website_fid_login": "0",
    "mh_sign": "8f3d145da20e561c68a8c6fb281188164cbe4825451b6fe5e4a4917dbe82d0c3",
    "goc": "o",
    "current_page_id": "12831",
    "browserQs": "wfwfid%3D29995%26pageId%3D12831%26websiteId%3D12159%26mhType%3D1%26publicId%3D592f522014953111ed0a1773672f6afc7b34%26mhEnc%3Db0e7922aaf5db008096d99251ad1df5e"
}
...
def get_sign():
    for _ in range(5):
        url = "https://www.pzhxqtsg.cn/engine2/m/0/11435/13362?p=12831"
...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 新闻公告
            {
                "url": "https://www.pzhxqtsg.cn/engine2/general/11435/type/more-datas",
                "page_number": 1,
                'data': {
                    "engineInstanceId": "13362",
                    "sign": "",
                    "pageNum": "1",
                    "pageSize": "20",
                    "typeId": "1000815",
