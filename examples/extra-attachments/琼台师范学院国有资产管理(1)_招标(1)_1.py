...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 国资要闻
            {
                "url": "https://gyzcgl.qtnu.edu.cn/gzyw.htm",
                "page_number": 1,
            },
            # 规章制度
            {
                "url": "https://gyzcgl.qtnu.edu.cn/gzzd.htm",
                "page_number": 1,
            },
        )
    ...
    def get_list(self, params: dict):
        ...
        rows = soup.select('div.news-list2 ul li')
    ...
    def get_content(self, params: dict):
        ...
        if a_tags := soup.select('.news-w1 a'):
            for a_tag in a_tags:
                if a_tag.get('href') and "download.jsp" in a_tag.get('href'):
