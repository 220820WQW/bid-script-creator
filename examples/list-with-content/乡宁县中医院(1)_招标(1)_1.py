...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 医院公告
            {
                "url": "http://www.xnxzyyy.cn/api/hospital/notice/list",
                "page_number": 1,
                'data': {
                    "pageNum": "1",
                    "pageSize": "10",
    ...
    def get_list(self, params: dict):
        ...
        for row in rows:
            ...
            url = f"http://www.xnxzyyy.cn/HospitalDetail?menuId=13&parentId=9&menuName=%E5%8C%BB%E9%99%A2%E5%85%AC%E5%91%8A&noticeId={noticeId}"
