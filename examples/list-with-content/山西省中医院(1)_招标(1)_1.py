...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 招标公告
            {
                "url": "https://www.sxszyy.com.cn/cms/content/list.do",
                "page_number": 1,
                'data': {
                    "categoryId": "1546419228411265025",
                    "pageNo": "1",
                    "pageSize": "9",
                    "pageTotal": "0",
                    "contentCount": "338"
    ...
    def get_list(self, params: dict):
        ...
        for row in rows:
            id = row.get('id')
            url = f"https://www.sxszyy.com.cn/html/web/infoOpen/index.html#/infoOpen/zhaobiaogonggao?id={id}"

            title = row.get('contentTitle')
