...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 通知公告
            {
                "url": "http://cwc.lyvc.edu.cn/tzgg.htm",
                "page_number": 1,
            },
            # 信息公开
            {
                "url": "http://cwc.lyvc.edu.cn/xxgk.htm",
                "page_number": 1,
            },
        )
    ...
    def get_list(self, params: dict):
        ...
        rows = soup.select('table.winstyle190570 tr[height="20"]')
        ...
        for row in rows:
            ...
            pubTime = row.select_one('span.timestyle190570').get_text(strip=True)
