...
class CrawlerObject(Spider):
    ...
    def init_func(cls):
        payload_list = (
            # 行政规范性文件
            {
                "url": "https://www.lhna.gov.cn/zwgk/zc/xzgfxwj",
                "page_number": 1,
            },
            # 其他文件
            {
                "url": "https://www.lhna.gov.cn/zwgk/zc/qtwj",
                "page_number": 1,
            },

            # 公示公告
            {
                "url": "https://www.lhna.gov.cn/zwgk/fdzdgknr/xxgk/gsgg",
                "page_number": 1,
            },
        )
    ...
    def get_list(self, params: dict):
        ...
        rows = soup.select('ul.infoList li')
